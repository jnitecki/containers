...
# install-linux.ps1). Unlike the Linux script, there's no QEMU/binfmt setup and no manifest
...
Start-Process -NoNewWindow -FilePath docker -ArgumentList ("push", "docker.io/jnitecki/azp-agent:windows-latest") -PassThru -Wait | Out-Null;
